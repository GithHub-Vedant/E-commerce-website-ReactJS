<<<<<<< HEAD:ecommerce-frontend/src/Pages/PaymentSuccess.jsx
      ...
      <div className="payment-success-container">
        ...
        <div className="order-items">
          ...
          <div className="items-list">
            {items.length > 0 ? (
              items.map((item, index) => (
                <div className="order-item" key={`${item.id}-${item.size}-${index}`}>
                  <div className="item-info">
                    <div>
...
>>>>>>> 2b8f2241b992710c5bb4216a5de61551c4861df9:src/Pages/PaymentSuccess.jsx
