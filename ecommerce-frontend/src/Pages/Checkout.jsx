...
const Checkout = () => {
  ...
  React.useEffect(() => {
    if (storedUser) {
      ...
      setFullName(storedUser.username || '');
    }
  }, [storedUser]);
  ...
  const handlePayment = async (paymentMethod) => {
    ...
    const orderRequest = {
      ...
      shippingAddress: `${selectedCity}, ${selectedState}, ${country}`,
      billingAddress: `${selectedCity}, ${selectedState}, ${country}`,
      shippingCost: shippingFee === 0 ? 0 : 50,
      tax: gst,
      items: []
    };
